                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('update_category/'.$category->id) }}">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label for="name" class="col-md-4 control-label">Name</label>
                                    <div class="col-md-6">
                                        <textarea class="input-block-level summernote" id="name" name="name">{{$category->name}}</textarea>
                                        <script>
                                        $('#name').summernote();
                                        </script>
                                    </div>
