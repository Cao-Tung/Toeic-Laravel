                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('update_post/'.$post->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title" type="text" class="form-control" name="title" value="<?php echo e($post->title); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="description" type="text" class="form-control" name="description" value="<?php echo e($post->description); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="input-block-level summernote" id="content" name="content"><?php echo e($post->content); ?></textarea>
                                        <script>
                                        $('#content').summernote();
                                        </script>
                                    </div>
